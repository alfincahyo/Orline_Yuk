    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getlist.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(SettingProfile.this, "Oops Something Wrong", Toast.LENGTH_LONG).show();
            }
        });
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(ceknama) && !TextUtils.isEmpty(cekno)){
                    ...
                    Toast.makeText(SettingProfile.this, "Isi Semua Form", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
